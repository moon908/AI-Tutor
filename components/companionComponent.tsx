...
import { SavedMessage, CompanionComponentProps } from "@/types"
...
const companionComponent = ({ subject, companionId, topic, name, userName, userImage, style, voice }: CompanionComponentProps) => {
            ...
            <section className="flex gap-8 max-sm:flex-col">
                <div className="companion-section">
                    <div className="companion-avatar"
                        ...
                        <div className={cn('absolute tracking-opacity duration-1000',
